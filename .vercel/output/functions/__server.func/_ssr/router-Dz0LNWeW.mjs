...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dz0LNWeW.js
var router_Dz0LNWeW_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-D-hKvt9u.css";
var APP_NAME = "Train LLM From Scratch";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "τ — training an LLM from scratch: one Transformer, a first loss, a source-line of stages, and a unique sink at chat."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter = () => import("./routes--_HTFy4d.mjs");
...
//#endregion
export { getRouter, router_Dz0LNWeW_exports as t };
